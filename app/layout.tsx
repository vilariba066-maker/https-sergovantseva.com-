        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `
              ...
              ym(108661371,'init',{clickmap:true,trackLinks:true,accurateTrackBounce:true,webvisor:true});
            `,
          }}
        />
        <noscript>
          <div>
            <img src="https://mc.yandex.ru/watch/108661371" style={{position:'absolute',left:'-9999px'}} alt="" />
          </div>
        </noscript>
      </head>
